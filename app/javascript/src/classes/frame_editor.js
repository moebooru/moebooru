...
export default FrameEditor = class FrameEditor {
  constructor(container, image_container, popup_container, options) {
    ...
    this.corner_draggers = ['.frame-editor-nw', '.frame-editor-ne', '.frame-editor-sw', '.frame-editor-se'].map((part) => {
      var cornerDraggerOptions, target;
  ...
  update_show_corner_drag() {
    var cornerDragger, j, len, ref, shown;
...
// Restore the elements we just hid.
  ...
  open(post_id) {
    var cornerDragger, j, len, onKeydownDocument, post, ref;
  ...
  create_dragger() {
    var dragElementOptions, ref;
    if ((ref = this.dragger) != null) {
      ref.destroy();
    }
    dragElementOptions = {
      ondown: (e) => {
        var clickedElement, clicked_elements, element, frame, frame_element, frame_idx, j, k, l, len, len1, len2, len3, m, post, ref1, ref2;
        post = Post.posts.get(this.post_id);
      ...
      ondrag: (e) => {
        var dims, frame_offset, post, source_dims;
        post = Post.posts.get(this.post_id);
        dims = void 0;
        source_dims = void 0;
  ...
  repopulate_table() {
    var _frame, i, imageFrame, j, k, len, len1, post, ref, ref1, tbody;
    post = Post.posts.get(this.post_id);
    // Clear the table.
  ...
  update_image_frame(frame_idx) {
    var cornerDragger, dimensions, div, frame, j, len, post, ref;
    post = Post.posts.get(this.post_id);
    frame = post.frames_pending[frame_idx];
  ...
  close() {
    var base, cornerDragger, dispose, j, k, len, len1, ref, ref1, ref2, tbody;
    if (this.post_id == null) {
      return;
    }
    this.post_id = null;

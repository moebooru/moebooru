window.UrlHashHandler = function()
{
...
UrlHashHandler.prototype.fire_observers = function(old_hash, new_hash)
{
  ...
  if(universal_observers !== null && universal_observers !== undefined)
...
UrlHashHandler.prototype.set_deferred = function(hash, replace)
{
  ...
  if(this.deferred_set_timer === null || this.deferred_set_timer === undefined)

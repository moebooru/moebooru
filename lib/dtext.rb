...
module DText
  ...
  def parseinline(str)
    ...
    str.gsub! /post #(\d+)/i, '<a href="/post/show/\1">post #\1</a>'
    str.gsub! /forum #(\d+)/i, '<a href="/forum/show/\1">forum #\1</a>'
    str.gsub! /comment #(\d+)/i, '<a href="/comment/show/\1">comment #\1</a>'
    str.gsub! /pool #(\d+)/i, '<a href="/pool/show/\1">pool #\1</a>'

...
this.Preload = {
  ...
  start_preload: function()
  {
    ...
    var i;
    for(i=0; i < Preload.preload_list.length; ++i)
    {
    ...
    for(i=0; i < Preload.preload_raw_urls.length; ++i)
    {

...
export default InlineImage = class InlineImage {
  ...
  register(id, data) {
    var button_id, container, idx, text, ui_html, viewer_img, zoom_id;
    container = $(id);
    data.html_id = id;
  ...
  expand(id) {
    var container, data, height, idx, image, images, img_html, img_id, src, viewer_img, width;
    container = $(id);
  ...
  show_image_no(id, idx) {
     ...
     * and flicker the old image at the new image's dimensions. 
        */
    var container, data, height, image, images, img, img_id, new_button, old_button, old_img, old_img_id, width, zoom;
    container = $(id);
    data = container.inline_image;
    images = data['images'];
    image = images[idx];
  ...
  zoom(id, dir) {
    ...
    var container, data, zoom, zoom_id;
    container = $(id);
    data = container.inline_image;
    if (dir === 0) {
      data.zoom_level = 0;

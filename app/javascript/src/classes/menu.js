...
export default Menu = class Menu {
  ...
  showSearchBox(elem) {
    var hide, search_box, search_text_box, show, submenu;
  ...
  syncForumMenu(reload = false) {
    var create_forum_item, forum_items_start, forum_menu_items, forum_submenu, last_read;
    if (reload) {

...
Rails.application.configure do
  ...
  config.middleware.use ExceptionNotification::Rack,
                        :ignore_exceptions => %w(ActionController::BadRequest ActionController::ParameterMissing ActionController::InvalidAuthenticityToken Mime::Type::InvalidMimeType) + ExceptionNotifier.ignored_exceptions,
                        :email => {

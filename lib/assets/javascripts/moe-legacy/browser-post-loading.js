...
PostLoader.prototype.preload_sample_image = function()
{
  ...
  if(cached_sample_urls === null || cached_sample_urls === undefined)
    return;
...
{
  if(this.result.pool_id === null || this.result.pool_id === undefined)
    return;
...
PostLoader.prototype.request_finished = function()
{
  ...
  var new_post_ids = [];
  if(result.posts !== null && result.posts !== undefined)
  {
...
PostLoader.prototype.load = function(load_options)
{
  ...
  if(!extending && (tags === null || tags === undefined) && (UrlHash.get("post-id") === null || UrlHash.get('post-id') === undefined))
  {
    UrlHash.set({tags: ""});
  ...
  if(this.result.tags === null || this.result.tags === undefined)
  {

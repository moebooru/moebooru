...
var TagCompletion, get_tag_from_string, join_data, split_data;
...
export default TagCompletion = class TagCompletion {
  ...
  load_data(onComplete) {
    ...
    this.loading = true;
    complete = () => {
      var callback, callbacks, i, len, results1;
      this.loading = false;
      this.loaded = true;
  ...
  update_tag_types_for_list(tags, allow_add) {
    ...
    Post.tag_types.each(function(tag_and_type) {
      var existing_tag, m, new_tag_string, tag, tag_idx, tag_string, tag_type, tag_type_idx;
      tag = tag_and_type[0];
  ...
  create_tag_search_regex(tag, options) {
    var first, last, letters, regex_parts, regex_string, s;
  ...
  add_recent_tag(tag) {
    var max_recent_tags_size, purge_at, tag_entry, tag_type, tag_type_idx;
  ...
  reorder_search_results(tag, results) {
    var bottom_results, re, top_results;
  ...
  complete_tag(tag, options) {
    var final_aliases, final_results, main_results, re, recent_result_count, recent_results, results, tag_types;

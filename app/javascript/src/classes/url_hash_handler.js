...
export default UrlHashHandler = class UrlHashHandler {
  ...
  fire_observers (old_hash, new_hash) {
    let all_keys, changed_hash_keys, observers_to_call, universal_observers;
  ...
  parse (hash) {
    let hash_path, hash_query, hash_query_values, i, key, keyval, query_params, value;
    if (hash == null) {
      hash = '';
    }
    if (hash.substr(0, 1) === '#') {

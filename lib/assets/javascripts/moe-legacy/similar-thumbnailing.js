 ...
 *
 */
window.ThumbnailUserImage = function(file, onComplete)
{
  /* Create the shared image pool, if we havn't yet. */
  if(ThumbnailUserImage.image_pool === null || ThumbnailUserImage.image_pool === undefined)
...
window.SimilarWithThumbnailing = function(form)
{
  this.similar = null;
  this.form = form;

 ...
 */
export default EmulateDoubleClick = class EmulateDoubleClick {
  constructor () {
  ...
  touchstart_event (event) {
    ...
    let distance, e, last_click, this_click, this_touch, time_since_previous;
  ...
  touchend_event (event) {
    let distance, last_click_identifier, last_click_position, this_click;
    if (this.last_click == null) {
      return;
    }
    last_click_identifier = this.last_click.identifier;
    if (last_click_identifier == null) {
      return;
    }
    last_click_position = this.last_click.position;

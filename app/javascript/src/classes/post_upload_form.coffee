export default class PostUploadForm
  constructor: (form, progress) ->
    ...
    @form_element.on 'submit', @form_submit_event
    @cancel_element.on 'click', @click_cancel
    document.on 'keydown', @document_keydown_event
    return

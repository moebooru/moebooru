...
export default DragElement = class DragElement {
  ...
  move_timer_update () {
    let anchored_x, anchored_y, last_event_params, relative_x, relative_y, x, y;
  ...
  mousedown_event (event) {
    let now, scrollLeft, scrollTop, x, y;

...
export default PostLoader = class PostLoader {
  ...
  preload_sample_image() {
    var cached_sample_urls, post_id, sample_url;
  ...
  request_finished() {
    var can_be_extended_further, i, new_post_ids, result;
    if (this.xhr.size > 0) {
      return;
    }
  ...
  load(load_options) {
    var disable_cache, extending, limit, pool_id, tags;
    if (!load_options) {
      load_options = {};
    }

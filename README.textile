...
apt-get install python-software-properties postgresql libpq-dev libxml2-dev libxslt-dev mercurial jhead build-essential libgd2-noxpm-dev

Brightbox repo for ruby works with this: http://blog.brightbox.co.uk/posts/next-generation-ruby-packages-for-ubuntu

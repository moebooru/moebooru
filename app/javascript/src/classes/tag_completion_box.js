...
var TagCompletionBox, createCompletionBox;
...
export default TagCompletionBox = class TagCompletionBox {
  ...
  input_keydown(event) {
    var backspaceTimeoutFn, deferTimeoutFn, focused;
  ...
  select_next(next) {
    var focused, new_focus, siblings;
    focused = this.completion_box.down('.focused');
  ...
  set_current_word(tag) {
    var after, before, cursor_position, offset, tag_text, text;
  ...
  update(force) {
    var aliases, data_available, h, i, li, offset, recent_result_count, span, tag, tag_aliases, tag_type, tags, tags_and_recent_count, ul;

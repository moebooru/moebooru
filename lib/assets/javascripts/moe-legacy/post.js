window.Post = {
  ...
  init_add_to_favs: function(post_id, add_to_favs, remove_from_favs) {
    ...
    {
      if((e !== null && e !== undefined) && (e.memo.post_ids.get(post_id) === null || e.memo.post_ids.get(post_id) === undefined))
        return;
  ...
  init_blacklisted: function(options) {
    ...
    if(list)
    {
      ...
      var inactive_blacklists_hidden = 0
      Post.blacklists.each(function(b) {
  ...
  resize_image: function() {
    ...
    if(img.original_width === null || img.original_width === undefined)
    {
    ...
    var ratio = 1;
    if ((img.scale_factor === 1) || (img.scale_factor === null || img.scale_factor === undefined)) {
  ...
  highres: function() {
    ...
    // un-resize
    if ((img.scale_factor !== null && img.scale_factor !== undefined) && (img.scale_factor !== 1)) {
      Post.resize_image();
    }
  ...
  {
    if(Post.hover_info_hovered_post === null || Post.hover_info_hovered_post === undefined)
      return;
  ...
  hover_info_update: function()
  {
    ...
    hover.down("#hover-is-child").show(post.parent_id !== null && post.parent_id !== undefined);
    ...
    jQuery
      ...
      .done(function(resp) {
        ...
        for (i = 0; i < resp.length; ++i) {
          post = resp[i];
          if (post.id === old_parent_id && (post.parent_id !== null && post.parent_id !== undefined)) {
            alert("The parent post has a parent, so this post can't be automatically reparented.");
            return;
          }
  ...
  InitBrowserLinks: function()
  {
    ...
    $$("A").each(function(a) {
      ...
      if(target.controller === "post" && target.action === "show")
      {
        ...
        if(current_pool_id !== null && current_pool_id !== undefined)
  ...
  get_cached_sample_urls: function()
  {
    ...
    if(Post.cached_sample_urls !== null && Post.cached_sample_urls !== undefined)
    ...
    if(sample_urls === null || sample_urls === undefined)
      return {};
  ...
  cache_sample_urls: function()
  {
    ...
    for(var post_id in sample_urls)
    {

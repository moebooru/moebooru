...
export default EmulateDoubleClick = class EmulateDoubleClick {
  ...
  touchstart_event(event) {
    ...
    var distance, e, last_click, this_click, this_touch, time_since_previous;
  ...
  touchend_event(event) {
    var distance, last_click_identifier, last_click_position, this_click;

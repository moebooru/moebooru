...
export default CornerDragger = class CornerDragger {
  constructor(container, part, options) {
    var box, dragElementOptions, frameBox;
    ...
    dragElementOptions = {
      ...
      ondrag: (e) => {
        var base, dims, post, source_dims;
        post = Post.posts.get(this.post_id);
  ...
  update() {
    var box, dims, div, frame, img, left, offset_height, offset_width, post, top;
